...
/* package ShapeServerAssignment-0.1.0.0 */
#ifndef VERSION_ShapeServerAssignment
#define VERSION_ShapeServerAssignment "0.1.0.0"
#endif /* VERSION_ShapeServerAssignment */
#ifndef MIN_VERSION_ShapeServerAssignment
#define MIN_VERSION_ShapeServerAssignment(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ShapeServerAssignment */
...
#define CURRENT_PACKAGE_KEY "ShapeServerAssignment-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "ShapeServerAssignment-0.1.0.0-inplace"
